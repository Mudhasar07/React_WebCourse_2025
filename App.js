    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                <RestaurantCard resName="Muda Kitchen" cuisine="Chicken" ratings="4.5"/>
                <RestaurantCard resName="Safa Kitchen" cuisine="Pizza" ratings="3.5"/>
                <RestaurantCard resName="Zida Kitchen" cuisine="Burger" ratings="3.5"/>
                <RestaurantCard resName="Saji Kitchen" cuisine="Pepsi" ratings="2.5"/>
            </div>
        </div>
    )
}
